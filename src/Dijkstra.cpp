...
struct Dijkstra::AdjListNode* Dijkstra::newAdjListNode(int dest, int weight){
...
struct Dijkstra::Graph* Dijkstra::createGraph(int V){
...
void Dijkstra::addEdge(struct Graph* graph, int src, int dest, int weight){
...
struct Dijkstra::MinHeapNode* Dijkstra::newMinHeapNode(int v, int dist){
...
struct Dijkstra::MinHeap* Dijkstra::createMinHeap(int capacity){
...
struct Dijkstra::MinHeapNode* Dijkstra::extractMin(struct MinHeap* minHeap){
    if (isEmpty(minHeap))
        return NULL;
...
void Dijkstra::printArr(int dist[], int n){
